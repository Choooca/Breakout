#include "win_screen_state.h"
#include <core/game.h>
#include <graphics/ui_button.h>
#include <state/play_state.h>
#include <state/title_card_state.h>

WinScreenState::WinScreenState(Game& game, int score) : MenuState(game), m_score_to_show(score) {
...
void WinScreenState::Update() {
	...
	TextStyle style;
	style.font_size = 100;
	m_game.m_text_renderer->RenderText("Win", m_game.m_window->GetWidth() * .5f, 300.0f, style);
